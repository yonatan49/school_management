...
const EditCourse = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setDurationHours(response.data.durationHours);
        setDurationWeeks(response.data.durationWeeks);
      ...
      .catch((error) => {
        setLoading(false);
        enqueueSnackbar('An error occured while fetching course details', { variant: 'error' });
        setFetchError(error);
        console.log(error);
      })
  }, [])
  ...
  const validate = () => {
    ...
    if (!tests || tests.length === 0 || tests.some(test => test.trim() === '')) {
      setTestsError('At least 1 test is required and cannot be empty')
      isValid = false
    } else {
      setTestsError('')
    }
  ...
  const handleEditCourse = (e) => {
    ...
    axios
      ...
      .catch((error) => {
        setIsSaving(false);
        enqueueSnackbar('An error occured while editing course', { variant: 'error' });
        console.log(error);
        setError(error);
      })
  }
      ...
      <div className='container2'>
        ...
        {loading ? (
          ...
          <div className="form-container">
            <div className="cont">
                <h3>Edit Course Details: {courseName}</h3>
                <hr />
